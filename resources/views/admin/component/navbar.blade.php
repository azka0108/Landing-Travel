<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">
      ...
      <ul class="header-nav ms-auto">
       ...
       <!--icon-icon sebelah foto profil dan menu pada foto profil-->
      <ul class="header-nav">
        ...
        <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <div class="avatar avatar-md"><img class="avatar-img" src="https://4.bp.blogspot.com/-Dlvx55meE9k/WZeAZLA51AI/AAAAAAAAC4Y/TwIWR_Bf4oQow81aMTQ4Gpsrg9UHeJ80wCLcBGAs/s1600/Dm5QxfaQ_400x400.jpg" alt="" width="50" height="50"></div>
          </a>
          <div class="dropdown-menu dropdown-menu-end pt-0">
            ...
            <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
              ...
              <form action="{{ route('sesi.logout') }}" method="POST" style="display: inline;">
                @csrf
