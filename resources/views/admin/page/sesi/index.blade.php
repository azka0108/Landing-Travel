...
<head>
  ...
  <style>
    /* CSS untuk memperbesar ukuran kotak login */
    .card.col-md-7 {
      width: 800px; /* Memaksimalkan lebar kartu */
      max-width: 1200px; /* Menyesuaikan ukuran maksimum yang lebih besar */
      text-align: center;
    }
    /* CSS untuk menengahkan kotak login */
    .container {
      display: flex;
      justify-content: center;
      align-items: center;
      min-height: 100vh; /* Agar kotak login berada di tengah layar */
    }
  </style>
          ...
          <div class="card-group d-block d-md-flex row">
            <div class="card col-md-7 p-4 mb-0">
              <div class="card-body">
                ...
                <form action="{{ route('sesi.login') }}" method="post" autocomplete="off">
                  @csrf
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input class="form-control" type="text" placeholder="Email" name="email"  autocomplete="off" readonly onfocus="this.removeAttribute('readonly')">
                    @error('username')
                  ...
                  <div class="input-group mb-4">
                    ...
                    <input class="form-control" type="password" placeholder="Password" name="password"  autocomplete="off" readonly onfocus="this.removeAttribute('readonly')">
                    @error('password')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </div>
